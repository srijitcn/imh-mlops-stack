...
[ML Config](../imh_mlops_stack/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore imh_mlops_stack/resources/README.md
...
Follow the instructions in [imh-mlops-stack/resources/README.md](../imh_mlops_stack/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../imh_mlops_stack/resources/README.md)  to propose, test, and deploy
