...
Opening a pull request will trigger a[workflow](../.github/workflows/imh-mlops-stack-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-8590162618558854.14.azuredatabricks.net#mlflow/models/staging-imh-mlops-stack-model)
* [Prod workspace registered model](https://adb-8590162618558854.14.azuredatabricks.net#mlflow/models/prod-imh-mlops-stack-model)
