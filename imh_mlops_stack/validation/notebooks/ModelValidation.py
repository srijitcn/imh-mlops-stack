...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``imh_mlops_stack/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in imh-mlops-stack/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in imh-mlops-stack/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-imh-mlops-stack-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev-imh-mlops-stack-model", "Model Name")
